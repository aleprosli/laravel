...
<div class="container-fluid">
    ...
    <a class="navbar-brand pt-0" href="{{ route('home') }}">
        <img src="{{ asset('argon') }}/img/brand/1.png" class="navbar-brand-img" alt="...">
    </a>
    <!-- User -->
        ...
        <ul class="navbar-nav">
            ...
            <li class="nav-item">
                <a class="nav-link active" href="#navbar-examples" data-toggle="collapse" role="button" aria-expanded="true" aria-controls="navbar-examples">
                    ...
                    <span class="nav-link-text" style="color: #f4645f;">Employee</span>
                </a>
            ...
            <li class="nav-item">
                <a class="nav-link" href="{{route('leave')}}">
                    <i class="ni ni-planet text-blue"></i> Leave
                </a>
            </li>
            <li class="nav-item">
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col">
                                ...
                                <a href="{{ route('mc.index') }}" class="btn btn-sm btn-primary">ClickHere</a>
                            </div>
